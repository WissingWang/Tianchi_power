...
train1 = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_3/F2_Result/train1AndPredictY.csv')
train1.record_date = pd.to_datetime(train1.record_date)
...
train2 = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_3/F2_Result/train2AndPredictY.csv')
train2.record_date = pd.to_datetime(train2.record_date)
...
train3 = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_3/F2_Result/train3AndPredictY.csv')
train3.record_date = pd.to_datetime(train3.record_date)
...
train4 = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_3/F2_Result/train4AndPredictY.csv')
train4.record_date = pd.to_datetime(train4.record_date)
...
test = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_3/F2_Result/testAndPredictY.csv')
...
if noWeekend_input_flag == 'y':
	joblib.dump(noWeekend_xgb_model, "./model/noWeekend_F3_xgb_model.m")
...
if Weekend_input_flag == 'y':
	joblib.dump(Weekend_xgb_model, "./model/Weekend_F3_xgb_model.m")
...
train1AndPredictY = train1AndPredictY[train1AndPredictY.record_date >= np.min(train1AndPredictY.record_date)+pd.to_timedelta(7, unit='D')]
train1AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_3/F3_Result/train1AndPredictY.csv', header=True, index=False)
...
train2AndPredictY = train2AndPredictY[train2AndPredictY.record_date >= np.min(train2AndPredictY.record_date)+pd.to_timedelta(7, unit='D')]
train2AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_3/F3_Result/train2AndPredictY.csv', header=True, index=False)
...
train3AndPredictY = train3AndPredictY[train3AndPredictY.record_date >= np.min(train3AndPredictY.record_date)+pd.to_timedelta(7, unit='D')]
train3AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_3/F3_Result/train3AndPredictY.csv', header=True, index=False)
...
train4AndPredictY = train4AndPredictY[train4AndPredictY.record_date >= np.min(train4AndPredictY.record_date)+pd.to_timedelta(7, unit='D')]
train4AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_3/F3_Result/train4AndPredictY.csv', header=True, index=False)
...
testAndPredictY = testAndPredictY[testAndPredictY.record_date >= np.min(testAndPredictY.record_date)+pd.to_timedelta(7, unit='D')]
testAndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_3/F3_Result/testAndPredictY.csv', header=True, index=False)
