...
print "loading model ..........."
noWeekend_F1_xgb_model = joblib.load("noWeekend_F1_xgb_model.m")
noWeekend_F2_xgb_model = joblib.load("noWeekend_F2_xgb_model.m")
noWeekend_F3_xgb_model = joblib.load("noWeekend_F3_xgb_model.m")
noWeekend_F4_xgb_model = joblib.load("noWeekend_F4_xgb_model.m")
noWeekend_F5_xgb_model = joblib.load("noWeekend_F5_xgb_model.m")
Weekend_F1_xgb_model = joblib.load("Weekend_F1_xgb_model.m")
Weekend_F2_xgb_model = joblib.load("Weekend_F2_xgb_model.m")
Weekend_F3_xgb_model = joblib.load("Weekend_F3_xgb_model.m")
Weekend_F4_xgb_model = joblib.load("Weekend_F4_xgb_model.m")
...
features1_noWeekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_powaer_rate', 'power_rate'], axis=1,inplace=True)
...
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
features1_Weekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_powaer_rate', 'power_rate'], axis=1,inplace=True)
...
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
features2_noWeekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_powaer_rate', 'power_rate'], axis=1,inplace=True)
...
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
features2_Weekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_powaer_rate', 'power_rate'], axis=1,inplace=True)
...
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
features3_noWeekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_powaer_rate', 'power_rate'], axis=1,inplace=True)
...
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
features3_Weekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_powaer_rate', 'power_rate'], axis=1,inplace=True)
...
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
features4_noWeekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_powaer_rate', 'power_rate'], axis=1,inplace=True)
...
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
features4_Weekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_powaer_rate', 'power_rate'], axis=1,inplace=True)
...
final_needdataset.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend/AllModel_Tianchi_power_predict_table_test.csv', header=True, index=False)
