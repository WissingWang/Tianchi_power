...
train1 = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend/F2_Result/train1AndPredictY.csv')
...
train1_noWeekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate'], axis=1,inplace=True)
...
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
train1_Weekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate'], axis=1,inplace=True)
...
train2 = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend/F2_Result/train2AndPredictY.csv')
...
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
train2_noWeekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate'], axis=1,inplace=True)
...
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
train2_Weekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate'], axis=1,inplace=True)
...
train3 = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend/F2_Result/train3AndPredictY.csv')
...
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
train3_noWeekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate'], axis=1,inplace=True)
...
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
train3_Weekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate'], axis=1,inplace=True)
...
train4 = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend/F2_Result/train4AndPredictY.csv')
...
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
train4_noWeekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate'], axis=1,inplace=True)
...
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
train4_Weekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate'], axis=1,inplace=True)
...
test = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend/F2_Result/testAndPredictY.csv')
...
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
test_noWeekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate'], axis=1,inplace=True)
...
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
test_Weekend_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate'], axis=1,inplace=True)
...
if noWeekend_input_flag == 'y':
	joblib.dump(noWeekend_xgb_model, "noWeekend_F3_xgb_model.m")
...
if Weekend_input_flag == 'y':
	joblib.dump(Weekend_xgb_model, "Weekend_F3_xgb_model.m")
...
train1_noWeekend_Y['power_consumption'] = train1_predict_noWeekend_Y
...
train1_Weekend_Y['power_consumption'] = train1_predict_Weekend_Y
...
train1AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend/F3_Result/train1AndPredictY.csv', header=True, index=False)
...
train2_noWeekend_Y['power_consumption'] = train2_predict_noWeekend_Y
...
train2_Weekend_Y['power_consumption'] = train2_predict_Weekend_Y
...
train2AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend/F3_Result/train2AndPredictY.csv', header=True, index=False)
...
train3_noWeekend_Y['power_consumption'] = train3_predict_noWeekend_Y
...
train3_Weekend_Y['power_consumption'] = train3_predict_Weekend_Y
...
train3AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend/F3_Result/train3AndPredictY.csv', header=True, index=False)
...
train4_noWeekend_Y['power_consumption'] = train4_predict_noWeekend_Y
...
train4_Weekend_Y['power_consumption'] = train4_predict_Weekend_Y
...
train4AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend/F3_Result/train4AndPredictY.csv', header=True, index=False)

test_noWeekend_Y['power_consumption'] = predict_noWeekend_Y
test_Weekend_Y['power_consumption'] = predict_Weekend_Y
...
testAndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend/F3_Result/testAndPredictY.csv', header=True, index=False)
