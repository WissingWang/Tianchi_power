...
if noWeekend_input_flag == 'y':
	joblib.dump(noWeekend_xgb_model, "noWeekend_F1_xgb_model.m")
...
if Weekend_input_flag == 'y':
	joblib.dump(Weekend_xgb_model, "Weekend_F1_xgb_model.m")
...
train1AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend/F1_Result/train1AndPredictY.csv', header=True, index=False)
...
train2AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend/F1_Result/train2AndPredictY.csv', header=True, index=False)
...
train3AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend/F1_Result/train3AndPredictY.csv', header=True, index=False)
...
train4AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend/F1_Result/train4AndPredictY.csv', header=True, index=False)
...
testAndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend/F1_Result/testAndPredictY.csv', header=True, index=False)
