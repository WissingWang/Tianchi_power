...
final_features1_noWeekend['predict_power_consumption'] = np.round(predict_noWeekend_Y1).astype(int)
final_features1_noWeekend_Y['power_consumption'] = np.round(predict_noWeekend_Y1).astype(int)
...
final_features1_Weekend['predict_power_consumption'] = np.round(predict_Weekend_Y1).astype(int)
final_features1_Weekend_Y['power_consumption'] = np.round(predict_Weekend_Y1).astype(int)
...
final_features2_noWeekend['predict_power_consumption'] = np.round(predict_noWeekend_Y2).astype(int)
final_features2_noWeekend_Y['power_consumption'] = np.round(predict_noWeekend_Y2).astype(int)
...
final_features2_Weekend['predict_power_consumption'] = np.round(predict_Weekend_Y2).astype(int)
final_features2_Weekend_Y['power_consumption'] = np.round(predict_Weekend_Y2).astype(int)
...
final_features3_noWeekend['predict_power_consumption'] = np.round(predict_noWeekend_Y3).astype(int)
final_features3_noWeekend_Y['power_consumption'] = np.round(predict_noWeekend_Y3).astype(int)
...
final_features3_Weekend['predict_power_consumption'] = np.round(predict_Weekend_Y3).astype(int)
final_features3_Weekend_Y['power_consumption'] = np.round(predict_Weekend_Y3).astype(int)
...
final_features4_noWeekend['predict_power_consumption'] = np.round(predict_noWeekend_Y4).astype(int)
final_features4_noWeekend_Y['power_consumption'] = np.round(predict_noWeekend_Y4).astype(int)
...
final_features4_Weekend['predict_power_consumption'] = np.round(predict_Weekend_Y4).astype(int)
final_features4_Weekend_Y['power_consumption'] = np.round(predict_Weekend_Y4).astype(int)
...
final_features5['predict_power_consumption'] = np.round(predict_Y5).astype(int)
