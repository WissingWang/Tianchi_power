...
train1 = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_2/F4_Result/train1AndPredictY.csv')
...
train1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate','power_mean', 'power_std'], axis=1,inplace=True)
...
train2 = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_2/F4_Result/train2AndPredictY.csv')
...
train2_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate','power_mean', 'power_std'], axis=1,inplace=True)
...
train3 = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_2/F4_Result/train3AndPredictY.csv')
...
train3_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate','power_mean', 'power_std'], axis=1,inplace=True)
...
train4 = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_2/F4_Result/train4AndPredictY.csv')
...
train4_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate', 'power_mean', 'power_std'], axis=1,inplace=True)
...
test = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_2/F4_Result/testAndPredictY.csv')
...
test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate', 'power_mean', 'power_std'], axis=1,inplace=True)
...
if input_flag == 'y':
	joblib.dump(xgb_model, "./model/noWeekend_F5_xgb_model.m")
print "predict ............"
