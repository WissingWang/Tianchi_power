...
final_dataset.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_2/result_CSV/statisTrueValue.csv', header=True, index=False)


predict_dataset = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_2/result_CSV/AllModel_Tianchi_power_predict_table_test.csv')
def test2(x):
...
predict_dataset.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_2/result_CSV/Tianchi_power_predict_table_test.csv', header=True, index=False)
