...
final_needdataset.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_And_weekend_2/result_CSV/AllModel_Tianchi_power_predict_table_test.csv', header=True, index=False)
