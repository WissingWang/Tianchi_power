...
rng = pd.date_range('10/1/2016', '10/31/2016')
...
handledataset = pd.read_csv(u'/home/haven/Tianchi_power/Tianchi_power__newold_boxhandle15_mergeDataset.csv')
...
features1 = handledataset[(handledataset.record_date>=pd.to_datetime('2015-01-01')+pd.to_timedelta(7*79+2, unit='D')) & (handledataset.record_date<(pd.to_datetime('2015-01-01')+pd.to_timedelta(7*91+2, unit='D')))]
...
features1_dayofweek_dataset = AllModelTransformByDOW.transformByDayOfWeek(features1)
...
features1_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate'], axis=1,inplace=True)

features1_Y = predicteData[(predicteData.predict_date>=(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*91+2, unit='D'))) & (predicteData.predict_date<(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*92+2, unit='D')))]
...
features2_dayofweek_dataset = AllModelTransformByDOW.transformByDayOfWeek(features2)
...
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
features2_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate'], axis=1,inplace=True)

features2_Y = predicteData[(predicteData.predict_date>=(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*92+2, unit='D'))) & (predicteData.predict_date<(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*93+2, unit='D')))]
...
features3_dayofweek_dataset = AllModelTransformByDOW.transformByDayOfWeek(features3)
...
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
features3_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate'], axis=1,inplace=True)

features3_Y = predicteData[(predicteData.predict_date>=(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*93+2, unit='D'))) & (predicteData.predict_date<(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*94+2, unit='D')))]
...
features4_dayofweek_dataset = AllModelTransformByDOW.transformByDayOfWeek(features4)
...
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
features4_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate'], axis=1,inplace=True)

features4_Y = predicteData[(predicteData.predict_date>=(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*94+2, unit='D'))) & (predicteData.predict_date<(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*95+2, unit='D')))]
...
features5_dayofweek_dataset = AllModelTransformByDOW.transformByDayOfWeek(features5)
...
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_mean', 'DOW_powaer_rate', 'power_mean', 'power_rate'], axis=1,inplace=True)
#test_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum'], axis=1,inplace=True)
features5_mergeDataset_add.drop(['DOW_power_sum', 'DOW_allsum', 'power_sum', 'DOW_power_rate', 'power_rate'], axis=1,inplace=True)

features5_Y = predicteData[(predicteData.predict_date>=(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*95+2, unit='D'))) & (predicteData.predict_date<(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*95+5, unit='D')))]
