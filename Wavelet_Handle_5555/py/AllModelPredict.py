...
addfeatures1 = handledataset[(handledataset.record_date>=pd.to_datetime('2015-01-01')+pd.to_timedelta(7*74, unit='D')) & (handledataset.record_date<(pd.to_datetime('2015-01-01')+pd.to_timedelta(7*75, unit='D')))]
features1AndPredictY = pd.concat([addfeatures1, features1, final_features1_Y], axis=0, ignore_index=True)
...
addfeatures2 = handledataset[(handledataset.record_date>=pd.to_datetime('2015-01-01')+pd.to_timedelta(7*73, unit='D')) & (handledataset.record_date<(pd.to_datetime('2015-01-01')+pd.to_timedelta(7*74, unit='D')))]
features2AndPredictY = pd.concat([addfeatures2, features2, final_features2_Y], axis=0, ignore_index=True)
...
addfeatures3 = handledataset[(handledataset.record_date>=pd.to_datetime('2015-01-01')+pd.to_timedelta(7*72, unit='D')) & (handledataset.record_date<(pd.to_datetime('2015-01-01')+pd.to_timedelta(7*73, unit='D')))]
features3AndPredictY = pd.concat([addfeatures3, features3, final_features3_Y], axis=0, ignore_index=True)
...
addfeatures4 = handledataset[(handledataset.record_date>=pd.to_datetime('2015-01-01')+pd.to_timedelta(7*71, unit='D')) & (handledataset.record_date<(pd.to_datetime('2015-01-01')+pd.to_timedelta(7*72, unit='D')))]
features4AndPredictY = pd.concat([addfeatures4, features4, final_features4_Y], axis=0, ignore_index=True)
