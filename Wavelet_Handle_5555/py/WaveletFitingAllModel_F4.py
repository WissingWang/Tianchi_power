...
train1 = pd.read_csv(u'../F3_Result/train1AndPredictY.csv')
...
train2 = pd.read_csv(u'../F3_Result/train2AndPredictY.csv')
...
train3 = pd.read_csv(u'../F3_Result/train3AndPredictY.csv')
...
train4 = pd.read_csv(u'../F3_Result/train4AndPredictY.csv')
...
train5 = pd.read_csv(u'../F3_Result/train5AndPredictY.csv')
...
train5_Y = handledataset[(handledataset.record_date>=(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*80, unit='D'))) & (handledataset.record_date<(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*81, unit='D')))]

final_train5 = pd.merge(train5_mergeDataset_add,train5_Y,on=['user_id', 'day_of_week'], how='left')


print "select train6 dataset ............."
train6 = pd.read_csv(u'../F3_Result/train6AndPredictY.csv')
...
train6_Y = handledataset[(handledataset.record_date>=(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*79, unit='D'))) & (handledataset.record_date<(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*80, unit='D')))]

final_train6 = pd.merge(train6_mergeDataset_add,train6_Y,on=['user_id', 'day_of_week'], how='left')


print "select train7 dataset ............."
train7 = pd.read_csv(u'../F3_Result/train7AndPredictY.csv')
...
train7_Y = handledataset[(handledataset.record_date>=(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*78, unit='D'))) & (handledataset.record_date<(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*79, unit='D')))]

final_train7 = pd.merge(train7_mergeDataset_add,train7_Y,on=['user_id', 'day_of_week'], how='left')

print "select train8 dataset ............."
train8 = pd.read_csv(u'../F3_Result/train8AndPredictY.csv')
...
train8_Y = handledataset[(handledataset.record_date>=(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*77, unit='D'))) & (handledataset.record_date<(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*78, unit='D')))]

final_train8 = pd.merge(train8_mergeDataset_add,train8_Y,on=['user_id', 'day_of_week'], how='left')


print "select train9 dataset ............."
train9 = pd.read_csv(u'../F3_Result/train9AndPredictY.csv')
...
train9_Y = handledataset[(handledataset.record_date>=(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*76, unit='D'))) & (handledataset.record_date<(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*77, unit='D')))]

final_train9 = pd.merge(train9_mergeDataset_add,train9_Y,on=['user_id', 'day_of_week'], how='left')


print "select train10 dataset ............."
train10 = pd.read_csv(u'../F3_Result/train10AndPredictY.csv')
...
train10_Y = handledataset[(handledataset.record_date>=(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*75, unit='D'))) & (handledataset.record_date<(pd.to_datetime('2015-01-01') + pd.to_timedelta(7*76, unit='D')))]

final_train10 = pd.merge(train10_mergeDataset_add,train10_Y,on=['user_id', 'day_of_week'], how='left')

print "select test dataset ............."
test = pd.read_csv(u'../F3_Result/testAndPredictY.csv')
...
addtrain1 = handledataset[(handledataset.record_date>=pd.to_datetime('2015-01-01')+pd.to_timedelta(7*62, unit='D')) & (handledataset.record_date<(pd.to_datetime('2015-01-01')+pd.to_timedelta(7*63, unit='D')))]
train1AndPredictY = pd.concat([addtrain1, train1, train1_Y], axis=0, ignore_index=True)
train1AndPredictY.to_csv(u'../F4_Result/train1AndPredictY.csv', header=True, index=False)
...
addtrain2 = handledataset[(handledataset.record_date>=pd.to_datetime('2015-01-01')+pd.to_timedelta(7*63, unit='D')) & (handledataset.record_date<(pd.to_datetime('2015-01-01')+pd.to_timedelta(7*64, unit='D')))]
train2AndPredictY = pd.concat([addtrain2, train2, train2_Y], axis=0, ignore_index=True)
train2AndPredictY.to_csv(u'../F4_Result/train2AndPredictY.csv', header=True, index=False)
...
addtrain3 = handledataset[(handledataset.record_date>=pd.to_datetime('2015-01-01')+pd.to_timedelta(7*64, unit='D')) & (handledataset.record_date<(pd.to_datetime('2015-01-01')+pd.to_timedelta(7*65, unit='D')))]
train3AndPredictY = pd.concat([addtrain3, train3, train3_Y], axis=0, ignore_index=True)
train3AndPredictY.to_csv(u'../F4_Result/train3AndPredictY.csv', header=True, index=False)
...
addtrain4 = handledataset[(handledataset.record_date>=pd.to_datetime('2015-01-01')+pd.to_timedelta(7*65, unit='D')) & (handledataset.record_date<(pd.to_datetime('2015-01-01')+pd.to_timedelta(7*66, unit='D')))]
train4AndPredictY = pd.concat([addtrain4, train4, train4_Y], axis=0, ignore_index=True)
train4AndPredictY.to_csv(u'../F4_Result/train4AndPredictY.csv', header=True, index=False)
...
addtrain5 = handledataset[(handledataset.record_date>=pd.to_datetime('2015-01-01')+pd.to_timedelta(7*61, unit='D')) & (handledataset.record_date<(pd.to_datetime('2015-01-01')+pd.to_timedelta(7*62, unit='D')))]
train5AndPredictY = pd.concat([addtrain5, train5, train5_Y], axis=0, ignore_index=True)
train5AndPredictY.to_csv(u'../F4_Result/train5AndPredictY.csv', header=True, index=False)
...
addtrain6 = handledataset[(handledataset.record_date>=pd.to_datetime('2015-01-01')+pd.to_timedelta(7*60, unit='D')) & (handledataset.record_date<(pd.to_datetime('2015-01-01')+pd.to_timedelta(7*61, unit='D')))]
train6AndPredictY = pd.concat([addtrain6, train6, train6_Y], axis=0, ignore_index=True)
train6AndPredictY.to_csv(u'../F4_Result/train6AndPredictY.csv', header=True, index=False)
...
addtrain7 = handledataset[(handledataset.record_date>=pd.to_datetime('2015-01-01')+pd.to_timedelta(7*59, unit='D')) & (handledataset.record_date<(pd.to_datetime('2015-01-01')+pd.to_timedelta(7*60, unit='D')))]
train7AndPredictY = pd.concat([addtrain7, train7, train7_Y], axis=0, ignore_index=True)
train7AndPredictY.to_csv(u'../F4_Result/train7AndPredictY.csv', header=True, index=False)
...
addtrain8 = handledataset[(handledataset.record_date>=pd.to_datetime('2015-01-01')+pd.to_timedelta(7*58, unit='D')) & (handledataset.record_date<(pd.to_datetime('2015-01-01')+pd.to_timedelta(7*59, unit='D')))]
train8AndPredictY = pd.concat([addtrain8, train8, train8_Y], axis=0, ignore_index=True)
train8AndPredictY.to_csv(u'../F4_Result/train8AndPredictY.csv', header=True, index=False)
...
addtrain9 = handledataset[(handledataset.record_date>=pd.to_datetime('2015-01-01')+pd.to_timedelta(7*57, unit='D')) & (handledataset.record_date<(pd.to_datetime('2015-01-01')+pd.to_timedelta(7*58, unit='D')))]
train9AndPredictY = pd.concat([addtrain9, train9, train9_Y], axis=0, ignore_index=True)
train9AndPredictY.to_csv(u'../F4_Result/train9AndPredictY.csv', header=True, index=False)
...
addtrain10 = handledataset[(handledataset.record_date>=pd.to_datetime('2015-01-01')+pd.to_timedelta(7*56, unit='D')) & (handledataset.record_date<(pd.to_datetime('2015-01-01')+pd.to_timedelta(7*57, unit='D')))]
train10AndPredictY = pd.concat([addtrain10, train10, train10_Y], axis=0, ignore_index=True)
train10AndPredictY.to_csv(u'../F4_Result/train10AndPredictY.csv', header=True, index=False)

test_Y['power_consumption'] = predict_Y
addtest = handledataset[(handledataset.record_date>=pd.to_datetime('2015-01-01')+pd.to_timedelta(7*66, unit='D')) & (handledataset.record_date<(pd.to_datetime('2015-01-01')+pd.to_timedelta(7*67, unit='D')))]
testAndPredictY = pd.concat([addtest, test, test_Y], axis=0, ignore_index=True)
testAndPredictY.to_csv(u'../F4_Result/testAndPredictY.csv', header=True, index=False)
