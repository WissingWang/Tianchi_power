...
train1AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_3/F1_Result/train1AndPredictY.csv', header=True, index=False)
...
train2AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_3/F1_Result/train2AndPredictY.csv', header=True, index=False)
...
train3AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_3/F1_Result/train3AndPredictY.csv', header=True, index=False)
...
train4AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_3/F1_Result/train4AndPredictY.csv', header=True, index=False)

test_Y['power_consumption'] = predict_Y
testAndPredictY = pd.concat([test, test_Y], axis=0, ignore_index=True)
testAndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle_3/F1_Result/testAndPredictY.csv', header=True, index=False)
