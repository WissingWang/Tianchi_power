...
train1 = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle(2)/F3_Result/train1AndPredictY.csv')
...
train2 = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle(2)/F3_Result/train2AndPredictY.csv')
...
train3 = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle(2)/F3_Result/train3AndPredictY.csv')
...
train4 = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle(2)/F3_Result/train4AndPredictY.csv')
...
test = pd.read_csv(u'/home/haven/Tianchi_power/Wavelet_Handle(2)/F3_Result/testAndPredictY.csv')
...
train1AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle(2)/F4_Result/train1AndPredictY.csv', header=True, index=False)
...
train2AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle(2)/F4_Result/train2AndPredictY.csv', header=True, index=False)
...
train3AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle(2)/F4_Result/train3AndPredictY.csv', header=True, index=False)
...
train4AndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle(2)/F4_Result/train4AndPredictY.csv', header=True, index=False)

test_Y['power_consumption'] = predict_Y
testAndPredictY = pd.concat([test, test_Y], axis=0, ignore_index=True)
testAndPredictY.to_csv(u'/home/haven/Tianchi_power/Wavelet_Handle(2)/F4_Result/testAndPredictY.csv', header=True, index=False)
